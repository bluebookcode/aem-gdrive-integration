 ...
 */
package com.aaemGdriveIntegration.core.models;
...
import com.aaemGdriveIntegration.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-gdrive-integration/components/helloworld");
